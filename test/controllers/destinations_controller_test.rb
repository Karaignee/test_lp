...
class DestinationsControllerTest < ActionController::TestCase
  ...
  test "should create destination" do
    assert_difference('Destination.count') do
      post :create, destination: { before_you_go: @destination.before_you_go, gettin_around: @destination.gettin_around, overview: @destination.overview, title: @destination.title }
    end
  ...
  test "should update destination" do
    patch :update, id: @destination, destination: { before_you_go: @destination.before_you_go, gettin_around: @destination.gettin_around, overview: @destination.overview, title: @destination.title }
    assert_redirected_to destination_path(assigns(:destination))
  end
